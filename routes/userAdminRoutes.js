...
router.get('/allAcc', userController.getAllAcc);
...
router.post('/createPreposte', userController.createPreposte);
...
router.put('/updateposte/:id', userController.updatePosteExStudent);
router.put('/updatePreposte/:id', userController.updatePreposte);
router.put('/updateAcc/:id', userController.updateAcc);
